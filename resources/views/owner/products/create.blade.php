...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="text-dark fw-800 mb-1"><i class="fa-solid fa-plus text-primary me-2"></i>Tambah Produk Baru</h2>
            <p class="text-muted">Daftarkan item barang dagangan baru ke inventori toko Anda</p>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control form-control-glass @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="Nama produk" minlength="3">
                                @error('name')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="sku" id="sku" class="form-control form-control-glass @error('sku') is-invalid @enderror" value="{{ old('sku') }}" required placeholder="Contoh: PROD-001">
                                    @error('sku')
                                        <div class="text-danger mt-1" style="font-size: 13px;">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="price" id="price" class="form-control form-control-glass @error('price') is-invalid @enderror" value="{{ old('price') }}" required placeholder="Minimal Rp 100" min="100">
                                    @error('price')
                                        <div class="text-danger mt-1" style="font-size: 13px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <label class="form-label" for="stock">Stok Awal <span class="text-danger">*</span></label>
                                    <input type="number" name="stock" id="stock" class="form-control form-control-glass @error('stock') is-invalid @enderror" value="{{ old('stock', 0) }}" required min="0">
                                    @error('stock')
                                        <div class="text-danger mt-1" style="font-size: 13px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" name="unit" id="unit" class="form-control form-control-glass @error('unit') is-invalid @enderror" value="{{ old('unit', 'pcs') }}" required placeholder="pcs, kg, pack">
                                    @error('unit')
                                        <div class="text-danger mt-1" style="font-size: 13px;">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" rows="3" class="form-control form-control-glass" placeholder="Keterangan lengkap detail produk barang..."></textarea>
                            </div>
